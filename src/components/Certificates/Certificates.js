...
import cert2 from "../../Assets/Certificates/AI Coursera.jpg";
      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="cert-card">
            <CertificateCards
              imgPath={cert1}
              title="AICTE & IBM SkillBuild Internship Certificate"
          ...
          <Col md={4} className="cert-card">
            <CertificateCards
              imgPath={cert2}
              title="Artificial Intelligence Certificate by IBM"
